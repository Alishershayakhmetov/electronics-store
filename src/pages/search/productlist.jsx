                ...
                <div className={style.itemImgDiv}>
                  <div className={style.productCartCarouselDiv}>
                    ...
                    <div className={style.strip}>
                      <span
                        className={style.marginLeft4px + " " + style.spanActive}
                        role="button"
                        tabIndex="0"
                      ></span>
                      <span
                        className={style.marginLeft4px}
                        role="button"
                        tabIndex="1"
                      ></span>
                      <span
